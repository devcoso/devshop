        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex justify-end p-5 text-white">
                    <a href="{{ route('categorias.create')}}" class="mr-0 md:mr-8  bg-lime-600 py-2 px-3 rounded-sm w-full text-center md:w-auto hover:bg-lime-700">
                        <i class="fa-solid fa-circle-plus"></i> Crear Categoria
                    </a>  
                </div>
